...
//		System.out.println("Value ====>"+CMA_CASH);
		Risk_Based_Test_Set_for_HIVE_OP_BUY.CMA_CASH_DATA = Double.parseDouble(CMA_CASH);
		return driver;	
	}
	@Test
...
//		System.out.println("Main portfolio value ====>"+cash_at_call);
		...
		Risk_Based_Test_Set_for_HIVE_OP_BUY.Macquarie_Bank_CMA_CASH_DATA = Double.parseDouble(Macquarie_CMA_CASH);
		return driver;	
	}
}
