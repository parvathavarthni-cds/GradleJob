...
public class Object_Factory {
	...
	@FindBy(xpath = "//*[@id=\"horizontal-menu\"]/ul/li[4]/a") // global request list button
	...
	@FindBy(xpath = "//div[@class='fs-label selected-status'][contains(text(),'Open')]") 
	public static WebElement status_filter_contains_me;
	
	@FindBy(xpath = "//*[@id=\"request-options-dd\"]/div/div[5]/div/div[2]/div[1]/input") // reporter filter
	public static WebElement status_filter_search;
	
	@FindBy(xpath = "//div[@class='fs-dropdown ps-container ps-theme-default ps-active-y']//div[@class='fs-option g0']//i")
	public static WebElement status_filter_option_open;
	...
	@FindBy(id = "customfield_16020") 
	public static WebElement security_stock_code_field;
