...
//	Admin Page elements
	...
	@FindBy(xpath = "//*[@id=\"edit_service_2\"]/div/div[5]/div/div/span[2]/label/span")
	public static WebElement once_otp_settings;
	...
	@FindBy(xpath = "//*[@id=\"m_header\"]/div/div/div[4]/div/ul/li/div/div/div/div/ul/li[3]")
	public static WebElement logout_dg;
...
//	SD Request list elements
	...
	@FindBy(xpath = "//*[@id=\"request-table\"]/tbody/tr[1]")	
	public static WebElement request_table_1st_value;
	
	@FindBy(xpath = "//*[@id=\"portfolio-request-table\"]/tbody/tr[1]")	
	public static WebElement portfolio_request_table_1st_value;
	...
	@FindBy(xpath = "//*[@id=\"request-table\"]/tbody/tr")
...
//	Dashboard page elements
	...
	@FindBy(xpath = "//*[@id=\"m_header\"]/div/div/div[4]/div/ul/li/a/span/img")
	public static WebElement profile_icon_advisor_dg_admin;
	
	@FindBy(xpath = "//*[@id=\"m_dropdown_api_1\"]/a")
	public static WebElement profile_icon_advisor;

	@FindBy(xpath = "//*[@id=\"m_dropdown_api_1\"]/div/div/div/div/ul/li[2]/a/span")
	public static WebElement logout_advisor;
	
	@FindBy(xpath = "//*[@id=\"m_header\"]/div/div/div[4]/div/ul/li/div/div/div/div/ul/li[3]/a/span")
	public static WebElement logout_advisor_dg_admin;
...
//	Portfolio level request list screen elements
	...
	@FindBy(xpath = "//*[@id=\"portfolio-request-table\"]/tbody/tr")
...
//  PV screen
	...
	@FindBy(id = "orders-tab")	
	public static WebElement orders_tab;
	
	@FindBy(xpath = "//*[@id=\"horizontal-menu\"]/ul/li[3]/a")
	public static WebElement global_orders_list;
	
	@FindBy(xpath = "//*[@id=\"portfolio_account_partial\"]/h4")
	public static WebElement investor_name_under_investor_tab;
	
	
//	orders list global
	
	@FindBy(xpath = "//span[contains(@class,'add-disabled disabled')]")
	public static WebElement place_an_order_button_in_order_list_global;
	
	@FindBy(id = "activities-search-content")	
	public static WebElement orders_list_section;
	
	@FindBy(id = "portfolio-order-content")	
	public static WebElement orders_list_section_portfolio_level;

	@FindBy(xpath = "//*[@id=\"order-table-wrapper\"]/div/div[3]/div")	
	public static WebElement status_dropdown_global_order_list;
	
	@FindBy(xpath = "//*[@id=\"order-table-wrapper\"]/div/div[3]/div/div[2]/div[1]/input")	
	public static WebElement status_dropdown_global_order_list_search;
	
	@FindBy(xpath = "//*[@id=\"order-table-wrapper\"]/div/div[3]/div/div[2]/div[4]/div[1]/span/i")	
	public static WebElement status_dropdown_global_order_list_first_value;
	
	@FindBy(id = "global_order_0")	
	public static WebElement global_order_list_first_record;
...
//	Place orders side tray
	...
	@FindBy(xpath = "//*[@id=\"pv_screen\"]/div/div[2]/div[1]/span[1]")
	public static WebElement cash_section_under_summary_tab;
	...
	public static WebElement portfolio_selection_dropdown_orders_searchbox;
	
	@FindBy(xpath = "//*[@id=\"select2-order_form_participants-results\"]/li")
	public static WebElement portfolio_selection_dropdown_orders_first_value;
...
//	Add BUY order extended Side tray
	...
	@FindBy(xpath = "//*[@id=\"add-order\"]/div/div[2]/div/div[3]/div[2]/div")	
	public static WebElement open_orders_sell;
	...
	@FindBy(xpath = "//*[@id=\"preview_disclaimer_footer\"]/div/p")
	public static WebElement PDS_text;
	...
	@FindBy(id = "pds_attachment_list")
	public static WebElement PDS_attachment_list_section;
	
	@FindBy(xpath = "//div[@class='download_icon']")
	public static WebElement PDS_download_icon;
	...
	@FindBy(xpath = "//*[@id=\"sell_order_tray\"]/div/div/span[1]")
	public static WebElement This_product_closed_for_sell;
...
//	Add SELL order extended Side tray
	...
	@FindBy(xpath = "//*[@id=\"select2-sell_dropdown-results\"]/li")
	public static WebElement Portfolio_holdings_list_1st_value;
	...
	@FindBy(xpath = "//input[@class='select2-search__field']")
	public static WebElement portfolio_holdings_searchbox;
	...
	@FindBy(id = "advice_div") //advice_section if clicked yes
	public static WebElement advice_section;
	...
	@FindBy(id = "advice_phone_method")  //advice method phone radio button
	public static WebElement advice_method_phone;
	...
	@FindBy(xpath = "//p[contains(text(),'TALARIA GLOBAL EQUITY (AUS0035AU)')]")  //draft second orders title
	public static WebElement draft_new_order;
	
	@FindBy(xpath = "/html[1]/body[1]/div[3]/div[8]/div[2]/div[2]/div[1]/div[1]/div[2]/div[2]/div[1]/img[1]")  //close second draft order
	...
	@FindBy(id = "pfFundUnit")   //No of units holded by asset in portfolio holdings list
	public static WebElement Portfolio_holdings_list_units;
	
	@FindBy(id = "orderAmtError")   
	public static WebElement SELL_order_amount_error;
	
	@FindBy(id = "max-units")   
	public static WebElement available_units;
	
	@FindBy(xpath = "//*[@id=\"sell_order_tray\"]/div/div/span[1]")   
	public static WebElement already_have_a_draft_order;
	
	@FindBy(xpath = "//*[@id=\"sell_order_tray\"]/div/div/div[2]/span")   
	public static WebElement edit_draft_order_button;
	
	@FindBy(id = "value_option")   
	public static WebElement value_radio_button;
	
	@FindBy(id = "full_redemption_option")   
	public static WebElement full_redemption_radio_button;
	
	@FindBy(id = "value_label")   
	public static WebElement value_label;
	
	@FindBy(id = "units_label")   
	public static WebElement units_label;
	
	@FindBy(id = "full_redemption_label")   
	public static WebElement full_redemption_label;
...
//	Preview order screen elements
	...
	@FindBy(id = "preview_accept_disclaimer_02")
...
//	APL
	...
	@FindBy(xpath = "//span[@class='closed-style-sell']")
	public static WebElement closed_for_sell;
	
	
// 	PWL Admin screen elements

	
	@FindBy(id = "user_datatable")
	public static WebElement user_list_table;
	

	@FindBy(xpath = "//input[@placeholder='Search...']")
	public static WebElement user_search_box;
	
	@FindBy(xpath = "/html[1]/body[1]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/table[1]/tbody[1]/tr[1]/td[7]/span[1]/a[1]/em[1]")
	public static WebElement user_edit_icon;
	
// 	PWL Admin user edit screen elements
	
	@FindBy(xpath = "//div[@class='m-card-profile__email']")
	public static WebElement edit_screen_user_profile_email;
	
	@FindBy(id = "edit-order-pad-permission")
	public static WebElement order_pad_permission_section;

	@FindBy(id = "can_trade")
	public static WebElement can_trade;
	
	@FindBy(id = "can_cancel_trade")
	public static WebElement can_cancel_trade;
	
	@FindBy(xpath = "/html[1]/body[1]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[2]/div[1]/form[1]/div[1]/div[6]/div[1]/div[1]/label[1]/span[1]")
	public static WebElement can_trade_checkbox;
	
	@FindBy(xpath = "/html[1]/body[1]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[2]/div[1]/form[1]/div[1]/div[6]/div[1]/div[1]/label[2]/span[1]")
	public static WebElement can_cancel_trade_checkbox;
	
	@FindBy(name = "commit")
	public static WebElement update_profile_button;
	
	
// 	order details side tray
	@FindBy(xpath = "//*[@id=\"SellData\"]/div/div[3]/div/p")
	public static WebElement order_status_label;
	
	@FindBy(id = "cancel_order_btn")
	public static WebElement cancel_order_button;
	
	@FindBy(xpath = "//*[@id=\"order_cancel_confirmation_pop_up\"]/div[2]/p[1]")
	public static WebElement cancel_order_popup_description;
	
	@FindBy(id = "confirm_cancel_order")
	public static WebElement cancel_order_popup_cancel_order_button;
	
	@FindBy(xpath = "//*[@id=\"order_cancel_confirmation_pop_up\"]/div[3]/button[1]")
	public static WebElement cancel_order_Go_back;
