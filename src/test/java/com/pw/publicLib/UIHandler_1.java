...
public class UIHandler_1 extends Page_factory{
	...
	public WebDriver Adviser_login(WebDriver driver, String username, String password) throws InterruptedException {
		...
		username_field.sendKeys("parvatha.varthni@crystaldelta.com");
		password_field.clear();
		password_field.sendKeys("HiveTest@0555");
		sign_in.click();
		Thread.sleep(5000);
		return driver;
	}
...
//	}
	...
	public WebDriver get_investor_portfolio_value(WebDriver driver) throws InterruptedException {
		WebDriverWait wait = new WebDriverWait(driver, 60);
		wait.until(ExpectedConditions.elementToBeClickable(product_logo));
		portfo_drop.click();
		// Need to add wait//
		wait.until(
				ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"investor-list-data\"]/table/tbody/tr[1]")));
		driver.findElement(By.xpath("/html/body/div[3]/div[2]/div[1]/div[2]/div/div[1]/div/input")).click();
		driver.findElement(By.xpath("/html/body/div[3]/div[2]/div[1]/div[2]/div/div[1]/div/input")).sendKeys("PWL1 Test");
		Thread.sleep(12000);
