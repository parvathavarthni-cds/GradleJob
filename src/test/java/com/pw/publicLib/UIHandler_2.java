...
public class UIHandler_2 extends Page_factory{
	...
	public static String draftorder;
	...
	public WebDriver Search_by_Request_ID_filter(WebDriver driver) throws InterruptedException {
		Assert.assertTrue(Request_ID_filter.isDisplayed());
		String response = request_table_1st_value.getText();
		Request_id = response.substring(2, 7);
		Request_ID_filter.click();
		LOGGER.log(Level.INFO, "Request ID filter is enable"); 
		Request_ID_filter.sendKeys(Request_id);
	...
	public WebDriver Result_for_Search_by_Request_ID_filter(WebDriver driver) throws InterruptedException {
		...
		String req_id = Request_ID.substring(2, 7);
		Assert.assertEquals(Request_id, req_id);
		LOGGER.log(Level.INFO, Request_id); 
		return driver;
	}
	...
	public WebDriver Search_by_Request_ID_filter_portfolio_level(WebDriver driver) throws InterruptedException {
		...
		String response = portfolio_request_table_1st_value.getText();
		Request_id = response.substring(0, 5);
		Portfolio_level_Request_ID_filter.click();
		LOGGER.log(Level.INFO, "Request ID filter is active"); 
		Portfolio_level_Request_ID_filter.sendKeys(Request_id);
	...
	public WebDriver Result_for_Search_by_Request_ID_filter_portfolio_level(WebDriver driver) throws InterruptedException {
		...
		String req_id = Request_ID.substring(0, 5);
		Assert.assertEquals(Request_id, req_id);
		LOGGER.log(Level.INFO, Request_id); 
		return driver;
	}
...
//		wait.until(ExpectedConditions.elementToBeClickable(place_an_order_button));
	...
	public WebDriver place_order_side_Tray(WebDriver driver) throws InterruptedException {
//		WebDriverWait wait = new WebDriverWait(driver, 120);
//		wait.until(ExpectedConditions.elementToBeClickable(SELL_Button));
	...
	public WebDriver portfolio_name_validate(WebDriver driver , String PV_Name) throws InterruptedException {
//		WebDriverWait wait = new WebDriverWait(driver, 120);
//		wait.until(ExpectedConditions.elementToBeClickable(SELL_Button));
		wait_until_clickable(driver,SELL_Button,120);
		String place_order_portfolio_name = portfolio_selection_dropdown_orders.getText();
		Assert.assertTrue(place_order_portfolio_name.contains(PV_Name));
		return driver;
	}
...
//		wait.until(ExpectedConditions.elementToBeClickable(portfolio_drop_place_order));
		wait_until_clickable(driver,portfolio_drop_place_order,120);
...
//		wait.until(ExpectedConditions.elementToBeClickable(side_tray_dropdown_searchbox));
		wait_until_clickable(driver,side_tray_dropdown_searchbox,120);
...
//		wait.until(ExpectedConditions.elementToBeClickable(search_result));		
		wait_until_clickable(driver,search_result,120);
...
//		wait.until(ExpectedConditions.elementToBeClickable(SELL_Button));
	...
	public WebDriver portfolio_holding_drop(WebDriver driver) throws InterruptedException {
//		WebDriverWait wait = new WebDriverWait(driver, 120);
...
//		wait.until(ExpectedConditions.elementToBeClickable(extended_sidetray_add_sell_cancel));
		wait_until_clickable(driver,extended_sidetray_add_sell_cancel,120);
		extended_sidetray_add_sell_cancel.click();
		Thread.sleep(2000);
		return driver;
	}
	
	public WebDriver portfolio_holdings_search(WebDriver driver,String fundname) throws InterruptedException {
//		WebDriverWait wait = new WebDriverWait(driver, 120);
//		wait.until(ExpectedConditions.elementToBeClickable(portfolio_holdings_drop));
		wait_until_clickable(driver,portfolio_holdings_drop,120);
...
//		wait.until(ExpectedConditions.elementToBeClickable(side_tray_dropdown_searchbox));
		wait_until_clickable(driver,side_tray_dropdown_searchbox,120);
		side_tray_dropdown_searchbox.sendKeys(fundname);
		Thread.sleep(2000);
		return driver;
	}

	public WebDriver validate_portfolio_holdings_search(WebDriver driver,String fundname) throws InterruptedException {
		Assert.assertTrue(portfolio_holding_search_result.isDisplayed());
		Assert.assertTrue(portfolio_holding_search_result_text.getText().contains("TALARIA GLOBAL EQUITY")||portfolio_holding_search_result_text.getText().contains("SMALLCO BROADCAP"));
...
//		wait.until(ExpectedConditions.elementToBeClickable(available_units_sell_order_screen));		
		wait_until_clickable(driver,available_units_sell_order_screen,120);
		return driver;
	}
...
//		System.out.println("Value is:"+values);
	...
	public WebDriver order_value_et(WebDriver driver, String order_final_value) {
		System.out.println("The order value is:===>"+total_order_value_sell_order_screen.getText());
...
//		Assert.assertFalse(advice_reason_textbox);
	...
	public WebDriver updated_details(WebDriver driver, String updated_order_value) {
		...
		System.out.println("Rearranged order value is===>"+order_value);
	...
	public WebDriver create_second_order(WebDriver driver, String o_value) throws InterruptedException {
		...
		portfolio_holdings_search(driver,"Talaria");
		validate_portfolio_holdings_search(driver,"TALARIA GLOBAL EQUITY");
	...
	public WebDriver validate_created_new_order(WebDriver driver) throws InterruptedException {
		Thread.sleep(2000);
		String second_order=draft_new_order.getText();
		System.out.println("Second draft order is===>"+second_order);

		//Assert.assertEquals(draft_new_order.getText(),portfolio_holding);
		System.out.println("Portfolio holding is===>"+portfolio_holding);
		Assert.assertEquals(second_order,portfolio_holding);
		return driver;
	}
	
	public WebDriver close_order(WebDriver driver) throws InterruptedException {
		Thread.sleep(2000);
		draftorder=draft_order_title.getText();
	...
	public WebDriver after_portfolio_impacts(WebDriver driver) {
		...
		System.out.println("Rearranged after units===>"+after_portfolio_impacts);
		return driver;
	}
	...
	public WebDriver asset_name_preview_screen(WebDriver driver) {
		...
		System.out.println("Before asset name ======>"+Before_asset_name);
		String After_asset_name = driver.findElement(By.xpath("//*[@id=\"preview-order-id\"]/div[4]/div[2]/div/label")).getText();
		System.out.println("After asset name ======>"+After_asset_name);
		Assert.assertTrue(draftorder.contains(Before_asset_name));
		Assert.assertTrue(draftorder.contains(After_asset_name));
		return driver;
	}
	...
	public WebDriver valdiate_order_confirmation(WebDriver driver) throws InterruptedException {
//		WebDriverWait wait = new WebDriverWait(driver, 120);
//		wait.until(ExpectedConditions.elementToBeClickable(confirm_order_content));
		wait_until_clickable(driver,confirm_order_content,120);
