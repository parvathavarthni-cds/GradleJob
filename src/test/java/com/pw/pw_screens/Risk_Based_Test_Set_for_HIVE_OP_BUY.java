...
public class Risk_Based_Test_Set_for_HIVE_OP_BUY extends DataProvider{
	...
	public static double CMA_CASH_DATA;
	public static float ANZ_Bank_CMA_CASH_DATA;
	public static double Macquarie_Bank_CMA_CASH_DATA;
	private UIHandler_3 Pagefactory = PageFactory.initElements(driver, UIHandler_3.class);
	private Logger LOGGER = Logger.getLogger(Risk_Based_Test_Set_for_HIVE_OP_BUY.class.getName());	
	...
	public void the_user_tries_to_place_a_BUY_order_with_Order_value_greater_than_Available_CMA_cash_balance() throws Throwable {
		Pagefactory.APL_asset_selection(driver, "HOW0098AU");
	...
	@Then("^the user should see the error message 'You are exceeding your available funds'$")
	...
	@Given("^the user creates a BUY order for value less than 'Available CMA cash balance'$")
	...
	@Given("^the user should have values in 'open orders' for the selected portfolio and asset$")
...
//		Pagefactory.remove_the_created_order_from_orders_DB(driver);
	...
	public void the_user_should_see_the_Available_funds_CMA_Cash_Open_order_Other() throws Throwable {
	...
	@Given("^the portfolio holds multiple cash accounts$")
	...
	@When("^the user tries to create a second BUY order$")
	...
	@Given("^the user clicks on 'BUY' button And navigates to 'APL' dropdown$")
	...
	public void the_user_searches_any_Managed_funds_which_is_not_present_in_the_APL() throws Throwable {
		Pagefactory.APL_asset_search(driver, "VEN0009AU");
	}

	@Then("^the user should see 'No Assets' message inside the dropdown$")
	public void the_user_should_see_No_Assets_message_inside_the_dropdown() throws Throwable {
	...
	public void the_user_searches_the_asset_Asset_code_which_is_under_investment_product_and_smartwrap_badge_but_not_under_the_dealer_group_Test_organisation_B(int arg1) throws Throwable {
		Pagefactory.APL_asset_search(driver, "VAN0110AU");
	}
	...
	@Given("^select one asset from the APL dropdown, which should have 'Disc-docs = WP' in the security master$")
	public void select_one_asset_from_the_APL_dropdown_which_should_have_Disc_docs_WP_in_the_security_master() throws Throwable {
		Pagefactory.APL_asset_selection(driver, "ASX6124AU");
		Pagefactory.enter_value_in_investment_amount_field(driver, (float) 100);
		Pagefactory.fill_neccessary_fields_to_enable_add_button(driver);
	}
	
	@Given("^select one asset from the APL dropdown, which should have 'Disc-docs = IM' in the security master$")
	public void select_one_asset_from_the_APL_dropdown_which_should_have_Disc_docs_IM_in_the_security_master() throws Throwable {
		Pagefactory.APL_asset_selection(driver, "BAR0001AU");
		Pagefactory.enter_value_in_investment_amount_field(driver, (float) 100);
		Pagefactory.fill_neccessary_fields_to_enable_add_button(driver);
	}
	...
	public void select_one_asset_from_the_APL_dropdown_which_should_have_Disc_docs_RP_in_the_security_master() throws Throwable {
		Pagefactory.select_asset_form_the_APL(driver, "BFL0001AU", (float) 100.00);
		Pagefactory.fill_neccessary_fields_to_enable_add_button(driver);
	}
	...
	public void advice_reason_Advice_date_Advice_method_fields_should_be_mandatory() throws Throwable {
		Pagefactory.check_fields_are_mandatory_when_YES_is_selected(driver);
	}
	...
	public void advice_summary_field_should_be_mAndatory_only_When_the_Other_option_is_selected_in_the_Advice_option_field() throws Throwable {
		Pagefactory.check_the_field_OTHER_is_mandatory_when_YES_is_selected(driver);
	}
	...
	public void the_user_selects_an_asset_from_the_APL_dropdown() throws Throwable {
		Pagefactory.APL_asset_selection(driver, "BFL0001AU");
	}
	...
	public void the_user_should_see_the_PDS_acknowledgement_checkbox() throws Throwable {
		Pagefactory.enter_required_fields(driver);
		Pagefactory.check_PDS_checkbox(driver);
	}
	...
	public void without_selecting_the_PDS_acknowledgement_checkbox_user_should_not_be_allowed_to_add_the_order_in_the_draft_section() throws Throwable {
		Pagefactory.check_Add_button_validation_based_on_PDS_checkbox(driver);
	}

	@Given("^the user is on 'Place orders' side tray under a portfolio with pension account$")
	public void the_user_is_on_Place_orders_side_tray_under_a_portfolio_with_pension_account() throws Throwable {
		Pagefactory.investor_selection(driver, "Ms Janet Orange");
		Pagefactory.place_orders_side_tray(driver);
	}

	@When("^the user searches the asset 'Asset_code' , which is approved for 'PIA' but not for 'SPA'$")
	public void the_user_searches_the_asset_Asset_code_which_is_approved_for_PIA_but_not_for_SPA() throws Throwable {
		Pagefactory.APL_asset_search(driver, "APN0023AU");
	}

	@Given("^the user is on 'Place orders' side tray under the second badge '\\(Smartwrap\\)'$")
	public void the_user_is_on_Place_orders_side_tray_under_the_second_badge_Smartwrap() throws Throwable {
		Pagefactory.investor_selection(driver, "PWL1 Test");
		Pagefactory.place_orders_side_tray(driver);
	}

	@When("^the user searches the asset 'Asset_code' , which is approved for 'PIA' and 'badge\\(wealth account\\)'$")
	public void the_user_searches_the_asset_Asset_code_which_is_approved_for_PIA_and_badge_smartwrap() throws Throwable {
		Pagefactory.APL_asset_search(driver, "WHT0023AU");
	}

	@When("^the asset 'Asset_code' is not approved for 'PIA' and 'badge\\(Smartwrap\\)'$")
	public void the_asset_Asset_code_is_not_approved_for_SPA_and_badge_Wealth_Account() throws Throwable {
	    
	}

	@Given("^the user is on 'Place orders' side tray under the 'DealerGroup\\((\\d+)\\)' and a portfolio with 'Pension' account$")
	public void the_user_is_on_Place_orders_side_tray_under_the_DealerGroup_and_a_portfolio_with_Pension_account(int arg1) throws Throwable {
		Pagefactory.investor_selection(driver, "Ms Janet Orange");
		Pagefactory.place_orders_side_tray(driver);
	}

	@When("^the user searches the asset 'Asset_code' , which is 'Operationally Ready=YES' and 'IssueOK=YES'$")
	public void the_user_searches_the_asset_Asset_code_which_is_Operationally_Ready_YES_and_IssueOK_YES() throws Throwable {
		Pagefactory.APL_asset_search(driver, "EQI0028AU");
	}

	@When("^the asset 'Asset_code' is approved for 'SAP' and 'badge\\(smartwrap\\)' but not enabled for the 'DealerGroup\\((\\d+)\\)'$")
	public void the_asset_Asset_code_is_approved_for_SAP_and_badge_smartwrap_but_not_enabled_for_the_DealerGroup(int arg1) throws Throwable {
	}

	@Given("^selects one asset 'ETL(\\d+)AU' from the APL dropdown, which has 'Disc-docs = NA' in the security master$")
	public void selects_one_asset_ETL_AU_from_the_APL_dropdown_which_has_Disc_docs_NA_in_the_security_master(int arg1) throws Throwable {
		Pagefactory.APL_asset_selection(driver, "ETL0072AU");
		Pagefactory.enter_value_in_investment_amount_field(driver, (float) 100);
		Pagefactory.fill_neccessary_fields_to_enable_add_button(driver);
	}
	@Then("^the user should see the 'No Assets' message inside the dropdown$")
	public void the_user_should_see_the_No_Assets_message_inside_the_dropdown() throws Throwable {
		Pagefactory.No_Assets_check(driver);
		driver.quit();
	}
}
